...
- REDIS Server-Only:
    ...
    ```
    - Test für Zugriff per Redis-Client:
        ```bash
...
- wenn auch bzw. nur lokal bereitgestellt werden soll, sind diese Schritte analog auch für den lokalen Host durchzuführen
